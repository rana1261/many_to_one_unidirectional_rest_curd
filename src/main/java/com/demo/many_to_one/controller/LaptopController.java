package com.demo.many_to_one.controller;

import java.util.List;

import javax.validation.Valid;

import com.demo.many_to_one.exception.NotFoundException;
import com.demo.many_to_one.model.Laptop;
import com.demo.many_to_one.model.Student;
import com.demo.many_to_one.repository.LaptopRepository;
import com.demo.many_to_one.repository.StudentRepository;
...
public class LaptopController {
    ...
    /*get  Laptops by Student's ID or  oi student id er under e koiti laptop ache ta dekhabe */
    ...
    public String deleteLaptop(@PathVariable Long studentId, @PathVariable Long laptopId) {
       ...
       return //laptopRepository.findById(laptopId)
        laptopRepository.findByLidAndStudentId(laptopId,studentId)
                .map(laptop -> {
